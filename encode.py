#!/usr/bin/env python
# coding: utf-8
# By Vindra ID: https://github.com/Dra-ID
...
def check_update():
    LATEST_VER = requests.get('https://raw.githubusercontent.com/Dra-ID/Py-Fuscate/main/.version').text.strip()
...
def update():
    if '.git' in os.listdir():
        ...
        latest_source = requests.get('https://raw.githubusercontent.com/Dra-ID/Py-Fuscate/main/encode.py').content
...
def main():
    ...
    with open(args.output, 'w') as output:
    	output.write("Vinzz=(\n")
        output.write('"000000000000000","000000000000000","000000000000000","000000000000000","000000000000000",\n')
        output.write('"000000000000000","000000000000000","000000000000000","000000000000000","000000000000000",\n')
        output.write('"000000000000000","000000000000000","000000000000000","000000000000000","000000000000000",\n')
        output.write(')\n'
        output.write(f'#{PYTHON_VERSION}\ntry:\n\t{encoded}\nexcept KeyboardInterrupt:\n\texit()')
